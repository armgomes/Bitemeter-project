...
//	#elif defined(__18F8722)
        ...
        // Card detect signal
        #define SD_CD               PORTCbits.RC3
        #define SD_CD_TRIS          TRISCbits.TRISC3

        // Write protect signal
        #define SD_WE               0                   // Não utilizado
        #define SD_WE_TRIS          TRISAbits.TRISA5
        ...
        // Defines for the HPC Explorer board
        #define SPICLOCK            TRISBbits.TRISB3
        #define SPIIN               TRISBbits.TRISB5
        #define SPIOUT              TRISBbits.TRISB4

        // Latch pins for SCK/SDI/SDO lines
        #define SPICLOCKLAT         LATBbits.LATB3
        #define SPIINLAT            LATBbits.LATB5
        #define SPIOUTLAT           LATBbits.LATB4

        // Port pins for SCK/SDI/SDO lines
        #define SPICLOCKPORT        PORTBbits.RB3
        #define SPIINPORT           PORTBbits.RB5
        #define SPIOUTPORT          PORTBbits.RB4
