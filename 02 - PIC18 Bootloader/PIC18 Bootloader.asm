...
#define NTX             0xFF
; *****************************************************************************
; Inicialização do PORTC
CLRF PORTC ; Initialize PORTC by clearing output data latches
CLRF LATC ; Alternate method to clear output data latches
MOVLW 0xC3 ; Value used to initialize data direction
MOVWF TRISC ; Value used to initialize data direction - Alterar aqui para fazer um debug com o LED Status
...
;    btfsc   RXPORT, RXPIN
    ...
    bcf BLUETOOTH
    ;bcf LED
    btfsc   sw1         ; Verifica o status do SW1
GotoAppVector:
    goto    AppVector           ; no BREAK state, attempt to start application
#endif
